...
+ (DTInstancetype)drawGradientImageWithRect:(CGRect)frame beginColor:(UIColor *)beginColor endColor:(UIColor *)endColor location:(CGFloat *)location
{
    return [self drawGradientImageWithRect:frame gradientColors:@[(id)beginColor.CGColor, (id)endColor.CGColor] location:location];
}

+ (DTInstancetype)drawGradientImageWithRect:(CGRect)frame gradientColors:(NSArray *)gradientColors location:(CGFloat *)location
{
