...
-(void)viewWillAppear:(BOOL)animated {
    ...
    if ( [UIView instancesRespondToSelector:@selector(needsUpdateConstraints)]){
...
- (void)reLayout {
	...
	self.nvBarMain.frame = CGRectMake(0, 0, nSrnWidth, 44+statusBarHeight);
	if( self.nvBarPicker )
		self.nvBarPicker.frame = CGRectMake(0, 0, nSrnWidth, 44+statusBarHeight);
